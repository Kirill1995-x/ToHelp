...
import com.tohelp.tohelp.prepare.InformationAboutFile;
...
public class FragmentTechSupport extends Fragment implements View.OnClickListener, com.tohelp.tohelp.interfaces.displayAlert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sharedPreferences.edit().putString("flag", "fifth_fragment").apply();
